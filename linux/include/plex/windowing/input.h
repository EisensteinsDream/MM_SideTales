...
extern "C"
{
	...
	// does what needs to be done if the reload signal is sent. Typically, you'll never need to call this

	extern void PLEX_reloadInputDefaults();
	...
	// returns whether or not certain keyboard keys are down
	...
	// determines the direction of a controller joystick. Controller is the controller ID (usually 0). axisNum is typically 0 for left joystick and 1 for right joystick.
