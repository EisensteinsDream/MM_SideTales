...
static const size_t p_chapterMax = 2;
...
static void p_selectionScreen()
{
	while(!PLEX_isTerminated())
	{
		...
		if(PLEX_drawButton(0, MMS_LANGUAGE_SELECTION_VOL1, PLEX_STANDARD_FW, PLEX_STANDARD_FH, PLEX_UNIT(1), PLEX_UNIT(8), PLEX_WW(true) - PLEX_UNIT(2), PLEX_UNIT(2), 0, 0, 0, 0, 170, 50, 50, 255, 0, 0, 0, 255, PLEX_UNIT(0.1), PLEX_LANGUAGE_ALPHASTRING, p_selectionFont, 0, true))
		{
			p_nextChapter = 0;
			return;
		}

		if(PLEX_drawButton(0, MMS_LANGUAGE_SELECTION_VOL2, PLEX_STANDARD_FW, PLEX_STANDARD_FH, PLEX_UNIT(1), PLEX_UNIT(11), PLEX_WW(true) - PLEX_UNIT(2), PLEX_UNIT(2), 0, 0, 0, 0, 50, 100, 50, 255, 0, 0, 0, 255, PLEX_UNIT(0.1), PLEX_LANGUAGE_ALPHASTRING, p_selectionFont, 0, true))
		{
			p_nextChapter = 1;
			return;
		}
...
int main(const int argc, char** args)
{
	...
	p_selectionBackdrop = PLEX_loadTextureFromFile(3840, 1640, 255, 255, 255, 255, 0, MMS_FILEPATH_TEX_SELECTIONBACK);
